...
namespace test1
{
    ...
    public class UnitTest1
    {
        ...
        public void TestToStr()
        {
            ...
            _list.Add(3);
            _list.Add(4);
            Assert.AreEqual("1234", _list.ToStr());
        }
        [TestMethod]
        public void TestAdd0()
        {
            Assert.AreEqual("", _list.ToStr());
        }
        [TestMethod]
        public void TestAdd2()
        {
            _list.Add(1);
            _list.Add(2);
            Assert.AreEqual("12", _list.ToStr());
        }
        [TestMethod]
        ...
        public void TestInsert()
        {
            ...
            _list.Add(1234);
            _list.Insert(2, 54);
            Assert.AreEqual("125431234", _list.ToStr());
        }
        [TestMethod]
        public void TestInsert_to_back()
        {
            ...
            Assert.AreEqual("123123454", _list.ToStr());
        }
        [TestMethod]
        public void TestRemoveAt_first()
        {
            ...
            _list.Add(1234);
            _list.RemoveAt(0);
            Assert.AreEqual("231234", _list.ToStr());
        }
        [TestMethod]
        public void TestRemoveAt_middle()
        {
            ...
            _list.Add(1234);
            _list.RemoveAt(1);
            Assert.AreEqual("131234", _list.ToStr());
        }
        [TestMethod]
        public void TestRemoveAt_negative()
        {
            ...
            _list.Add(3);
            _list.Add(1234);
            Assert.AreEqual("1231234", _list.ToStr());
        }
        [TestMethod]
        public void TestRemove()
        {
            ...
            _list.Add(1234);
            _list.Remove(3);
            Assert.AreEqual("121234", _list.ToStr());
        }
        [TestMethod]
